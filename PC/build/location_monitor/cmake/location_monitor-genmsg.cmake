...
set(MSG_I_FLAGS "-Ilocation_monitor:/home/mondi/catkin_ws/src/location_monitor/msg")
...
get_filename_component(_filename "/home/mondi/catkin_ws/src/location_monitor/msg/landmarkDistance.msg" NAME_WE)
add_custom_target(_location_monitor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "location_monitor" "/home/mondi/catkin_ws/src/location_monitor/msg/landmarkDistance.msg" ""
)
...
_generate_msg_cpp(location_monitor
  "/home/mondi/catkin_ws/src/location_monitor/msg/landmarkDistance.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/location_monitor)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/location_monitor\")")
  # install generated code
  install(
